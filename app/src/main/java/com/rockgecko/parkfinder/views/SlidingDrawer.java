...
package com.rockgecko.parkfinder.views;
...
public class SlidingDrawer extends ViewGroup {
    ...
    public static interface OnDrawerScrollListener {
        ...
        /**
         *
         * @param scrollOffset between 0 (closed) and 1 (full open)
         */
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mOnDrawerScrollListener != null) {
                mOnDrawerScrollListener.onDrawerScrollStarted();
            }
...
//                                        mHandleWidth - mTapThreshold)) {
    ...
    private void moveHandle(int position) {
        ...
        if (mVertical) {
            if (position == EXPANDED_FULL_OPEN) {
            	if(scrollListener!=null) scrollListener.onDrawerScroll(1);
                handle.offsetTopAndBottom(mTopOffset - handle.getTop());
                invalidate();
            } else if (position == COLLAPSED_FULL_CLOSED) {
            	if(scrollListener!=null) scrollListener.onDrawerScroll(0);
                handle.offsetTopAndBottom(mBottomOffset + getHeight()-
                        mHandleHeight - handle.getTop());
                invalidate();
            } else {
                final int top = handle.getTop();
                if(scrollListener!=null)scrollListener.onDrawerScroll(1f-((float)(position-mTopOffset))/(getHeight()-mTopOffset-mHandleHeight));
            ...
            if (position == EXPANDED_FULL_OPEN) {
                ...
                if(scrollListener!=null)scrollListener.onDrawerScroll(1f-((float)(position))/(getWidth()-mHandleWidth));
                //if(scrollListener!=null) scrollListener.onDrawerScroll(1f-((float)position)/getWidth());
    ...
    private void stopTracking() {
        ...
        if (mOnDrawerScrollListener != null) {
            mOnDrawerScrollListener.onDrawerScrollEnded();
        }
    ...
    public void animateClose() {
        ...
        if (scrollListener != null) {
            scrollListener.onDrawerScrollStarted();
        }
        animateClose(mVertical ? mHandle.getTop() : mHandle.getLeft());

        if (scrollListener != null) {
            scrollListener.onDrawerScrollEnded();
        }
    }
