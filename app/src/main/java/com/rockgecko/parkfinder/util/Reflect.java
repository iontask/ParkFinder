...
public class Reflect {
	...
	public static String stringForId(int resId) throws NotFoundException{
		...
		try{
			Context c = ParkFinderApplication.getContextStatic();
	...
	public static int getImageResId(String imageName) {
        ...
        /*
		try {
			return getResId(imageName.toLowerCase(), Class.forName(TBSApplication.getContextStatic().getPackageName()+".R$drawable"));
...
*/
	...
	/**
	 * Performs a VisibleFromSelector method of the object. See iPhone's
	 ...
	 * @return
	 */
	public static boolean visibleFromSelector(Object object, String selector) {

		Object result = invoke(object, selector, (Class[]) null, (Class[]) null);
		if (result == null)
			return true;
